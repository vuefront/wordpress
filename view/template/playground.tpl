<html>
	<head>
	    ...
	    <script type="text/javascript" src="catalog/view/javascript/d_vuefront/js/middleware.js"></script>
	    <link rel="stylesheet" type="text/css" href="catalog/view/javascript/d_vuefront/css/index.css">
